# Buleku Manchu Lookup: Chrome Extension

This branch contains the Google Chrome version of the Buleku Manchu lookup extension.
...
5. Choose the repository root folder from this branch.
